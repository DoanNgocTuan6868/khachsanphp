      ...
      <div class="span8">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form action="model/cf_traphong.php" method="post" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="control-group">
                    <label for="tg_nhanphong" class="control-label">Thời Nhận Phòng : </label>
                <div class="controls">
                    <input type="text" class="span5" id="tg_nhanphong" name="tg_nhanphong" value="<?php echo $row ['tg_nhanphong'] ?>" required>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Thời Trả Phòng :</label>
                <div class="controls">
              ...
              <div class="control-group">
                    <label for="giadv" class="control-label">Giá Dịch Vụ : </label>
                <div class="controls">
                    <input type="text" class="span5" id="giadv" name="giadv" value="<?php echo $row ['giadv'] ?>">
                </div>
              </div>
                

              <div class="form-actions">
                <button type="submit" class="btn btn-success" style="margin-left: 40%;">Trả Phòng</button>
              </div>
            </form>
          </div>
        </div>
