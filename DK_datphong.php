      ...
      <div class="span8">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form action="model/cf_DKphong.php" method="post" class="form-horizontal">
              <div class="control-group">
                    <label for="tenkhachhang" class="control-label">Tên khách hàng : </label>
                <div class="controls">
                    <input type="text" class="span11" id="tenkhachhang" name="tenkhachhang"  required>
                </div>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="span11" id="sdt_kh" name="sdt_kh"  required>
                </div>
              </div>
              <div class="control-group">
                    <label for="cmnd_kh" class="control-label">CMND/CCCD : </label>
                <div class="controls">
                    <input type="text" class="span11" id="cmnd_kh" name="cmnd_kh"  required>
                </div>
              </div>
              <div class="control-group">
                    <label for="sl_khach" class="control-label">Số Người : </label>
                <div class="controls">
                    <input type="text" class="span11" id="sl_khach" name="sl_khach"  required>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="span5" id="maloaidv" name="maloaidv" required>
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <input class="form-control span11" placeholder="dd/m/yy" type="datetime-local" name="tg_datphong">  
                </div>
              </div>
              <div class="control-group">
              ...
              <div class="form-actions">
                <button type="submit" class="btn btn-success" style="margin-left: 40%;">Đặt Phòng</button>
              </div>
            </form>
          </div>
        </div>
